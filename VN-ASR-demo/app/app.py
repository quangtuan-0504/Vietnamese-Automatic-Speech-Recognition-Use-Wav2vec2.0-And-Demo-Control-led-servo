...
def plot_audio_transformations(y, sr, pipeline: audiomentations.Compose, path_save):
    ...
    with col1:
        st.markdown(
            f"<h4 style='text-align: center; color: black;'>Spectrogram</h5>",
...
def main():
    ...
    if True:
        ...
        with col2:
            st.image("./VN-ASR-Demo/app/assets/demoo.gif")
...
if __name__ == "__main__":
    st.set_page_config(layout="wide", page_title="VN Speech2text And Visualize")
    main()